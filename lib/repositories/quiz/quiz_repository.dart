...
import 'package:preguntasapp/models/failure_model.dart';
import 'package:preguntasapp/models/question_model.dart';
import 'package:preguntasapp/enums/difficulty.dart';
import 'package:preguntasapp/repositories/quiz/base_quiz_repository.dart';
...
class QuizRepository extends BaseQuizRepository {
  ...
  Future<List<Question>> getQuestions({
    ...
    try {
      ...
      print(err);
      throw Failure(
        message: err.response?.statusMessage ?? 'Algo salio mal!',
      );
    } on SocketException catch (err) {
      print(err);
      throw const Failure(message: 'Porfavor revise su conexión.');
    }
  }
}
